...
func TestGetUserNegativ(t *testing.T) {
	...
	allowed := GetUser("wrong_user", "wrong_password", "testid")
	if allowed {
...
func TestGetUserWithTokenPositiv(t *testing.T) {
	...
	allowed := GetUser("mock_token_superuser", "", "testid")
	if !allowed {
...
func TestGetUserWithTokenNegative(t *testing.T) {
	...
	allowed := GetUser("wrong_token", "", "testid")
	if allowed {
...
func TestGetSuperuserPositiv(t *testing.T) {
	...
	GetUser("test_superuser", "test_superuser", "testid")
...
func TestGetSuperuserNegativ(t *testing.T) {
	...
	GetUser("test_normaluser", "test", "testid")
...
func TestRefreshExpiredAccessTokenWithoutCrediantials(t *testing.T) {
	...
	if CI {
		...
		GetUser("mock_token_superuser", "", "testid")
...
func TestACLWithPatternSubstitution(t *testing.T) {
	...
	GetUser("test_normaluser", "test_normaluser", "testid")
